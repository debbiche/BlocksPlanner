  ;; This is a rudimentary implementation of the Shrdlite domain
  ;; It uses position information instead row and column indices
  ;; Missing features:
  ;;    - Above, beside, inside
                    ...
                    (and
                      ...
                      (exists (?column) 
                        (and
                          ...
                          (column(?column ?columnIndex))
                          ;; There should not be a block that is a pyramid or ball 
                          ;; and that is topmost of that column
                          (not
                            (exists (?otherBlock)
                              (and
